...
client.connect( ('129.161.40.58', 6666) )

client2 = OSC.OSCClient()
client2.connect (('129.161.12.104', 6666))

#129.161.12.207  Riker
#129.161.12.104  Worf
#129.161.12.207#
#129.161.12.193#
...
class World(DirectObject.DirectObject):
    ...
    def update (self,t):
        ...
        #msg.append("%f %f %f %f %f %f"%(wp.getX() , wp.getY() , wp.getZ(), 180-wr.getX() +5, wr.getY(), wr.getZ() ))
